...
--- parse String -> Data
--- encode Data -> String
local generateParser = function(
  datatype, parse, encode
 )
  return {
    [0] = datatype:lower();
    [1] = encode;
...
local Parsers = {
  ...
  generateParser(
    'function', function( str )
      ...
      return function()
        error(
          'Cannot parse functions yet. Please try again later',
          2
        )
      end;
    end
  ...
  generateParser(
    'UDim', function( udim )
      return udim.Scale .. '\6' .. udim.Offset
    end, function( str )
  ...
  generateParser(
    'UDim2', function( u2 )
      return u2.X.Scale .. '\6' .. u2.Y.Scale ..
               '\6' .. u2.X.Offset .. '\6' ..
               u2.Y.Offset
    end, function( str )
      local split = Util.split_fast(str, '\6')
